...
public class Player {
    ...
    public int dealAutomated(Deck d) {				//method for predefined conservative dealing: 
        Scanner input = new Scanner(System.in);  
        int value;
        System.out.println("Dealing with:\t"+this.getName());
    ...
    public int dealAutomatedStupid(Deck d) {      // method for risky dealing
        Scanner input = new Scanner(System.in);  
        int value;
        System.out.println("Dealing with:\t"+this.getName());
    ...
    public boolean mannaLogic(){
        if(this.gethandsValue()<=16) return true;
        else return false;
    }
